 ...
 const handleSubmit = async (e) => {
   ...
   try {
     ...
     const response = await fetch(`${API_URL}/api/auth/complete-reset`, {
       ...
       body: JSON.stringify({
         token: token, // Ajoutez le token dans le corps aussi
         newPassword: password,
         confirmPassword: confirmPassword // Ajoutez la confirmation
       })
     });
            ...
            {confirmPassword && (
              <div className="password-match">
                {password === confirmPassword ? (
                  <span className="match"><FiCheck /> Les mots de passe correspondent</span>
                ) : (
                  <span className="no-match"><FiX /> Les mots de passe ne correspondent pas</span>
                )}
              </div>
            )}
          </div>
